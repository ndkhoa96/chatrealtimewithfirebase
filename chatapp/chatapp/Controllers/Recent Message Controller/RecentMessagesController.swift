...
class RecentMessagesController: BaseTableViewController {
    ...
    func observeUserMessages(){
        ...
        let dbRef = Database.database().reference().child(KEY_DATA.USER_MESSAGES.ROOT).child(uid)
    ...
    func pushNotificationWhenReceiveMessages(title: String, body: String){
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let dbRef = DBProvider.shared.users.child(chatPartnerId)
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        let actionOk = UIAlertAction(title: "Delete Conversation", style: .destructive) { (alert) in
            ...
            if let chatPartnerId = message.chatPartnerId(){
                Database.database().reference().child(KEY_DATA.USER_MESSAGES.ROOT).child(uid).child(chatPartnerId).removeValue { (error, ref) in
                    if error != nil {
